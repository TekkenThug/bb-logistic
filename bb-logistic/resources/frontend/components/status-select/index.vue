<template>
    <div class="admin-client__filter">
        <select :value="filter" @input="$emit('input', $event.target.value)" class="form-select" id="order-filter">
            <option class="btn-filter" value="" selected>Выберите фильтр</option>
